...
from src.model.graphmaker import GraphJointDiffuser
from src.utils import load_and_standardize
from src.model.graphmaker.utils import get_marginal, get_one_hot
from src.model.graphmaker.setup_utils import load_train_yaml
...
def train_diffuser(dataset):
    ...
    # train_dataloader = egograph dataloader
